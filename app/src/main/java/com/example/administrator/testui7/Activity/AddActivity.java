...
public class AddActivity extends AppCompatActivity implements RadioGroup.OnCheckedChangeListener{
    ...
    String APPID = "376f1cc3355ed774826bf66035e39999";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        price = (EditText) findViewById(R.id.et_add_number);
        ...
        if (requestCode == REQUESTPERMISSION) {
            if (permissions[0].equals(Manifest.permission.WRITE_EXTERNAL_STORAGE)) {
                if (grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    //提示没有权限，安装不了
                    Toast.makeText(AddActivity.this,"您拒绝了权限，这样无法安装支付插件",Toast.LENGTH_LONG).show();
                }
            }
        }
    }
    ...
    void pay(final boolean alipayOrWechatPay) {
        if (alipayOrWechatPay) {
            if (!checkPackageInstalled("com.eg.android.AlipayGphone",
                ...
                Toast.makeText(AddActivity.this, "请安装支付宝客户端", Toast.LENGTH_SHORT)
                        .show();
                return;
            }
        } else {
...
//                    installBmobPayPlugin("bp.db");
                ...
                Toast.makeText(AddActivity.this, "请安装微信客户端", Toast.LENGTH_SHORT).show();
                return;
            }
        }

        showDialog("正在获取订单...\nSDK版本号:" + BP.getPaySdkVersion());
        final String name = "充值";
        ...
        BP.pay("充值","网络教学平台充值", getPrice(), alipayOrWechatPay, new PListener() {

            // 因为网络等原因,支付结果未知(小概率事件),出于保险起见稍后手动查询
            @Override
            public void unknow() {
                Toast.makeText(AddActivity.this, "支付结果未知,请稍后手动查询", Toast.LENGTH_SHORT)
                        .show();
                hideDialog();
            }
            ...
            @Override
            public void succeed() {
                Toast.makeText(AddActivity.this, "支付成功!", Toast.LENGTH_SHORT).show();
                BmobUser bu = BmobUser.getCurrentUser();
                bu.setValue("money",getPrice());
                bu.save();
                hideDialog();
            }
...
//                    installBmobPayPlugin("bp.db");
                    ...
                    Toast.makeText(AddActivity.this, "支付中断!"+reason+code, Toast.LENGTH_SHORT)
                            .show();
                }
                hideDialog();
            }
